export const environment = {
  ...
  // Exposed url by ngRok https://ee7f4fd7.ngrok.io
  production: true,

  users_api_url: 'https://ee7f4fd7.ngrok.io/api/v1/users',
  users_api_backend_type: 'java',

  educational_institution_url: 'https://ee7f4fd7.ngrok.io/api/v1/establishments',
  educational_institution_api_backend_type: 'java',

  level_url: 'https://ee7f4fd7.ngrok.io/api/v1/levels',
  level_url_api_backend_type: 'java',

  field_url: 'https://ee7f4fd7.ngrok.io/api/v1/fields',
  field_url_api_backend_type: 'java',

  classe_url: 'https://ee7f4fd7.ngrok.io/api/v1/classes',
  classe_url_api_backend_type: 'java',

  course_url: 'https://ee7f4fd7.ngrok.io/api/v1/courses',
